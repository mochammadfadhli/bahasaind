<?php
require_once('konek.php');//Koneksi ke database

//fungsi untuk mengecek kata dalam tabel dictionary
function cekKamus($kata){ 
	$sql = mysql_query("SELECT * from dictionary where word ='$kata' LIMIT 1");
...
function Cek_Prefix_Disallowed_Sufixes($kata){
	//i : case insentive (mendeteksi huruf besar & kecil)
	//\z : mencari pola diakhiran string
